    ...
    public class ProductsController : Controller
    {
        ...
        public ActionResult Index()
        {
            if (Session["SESSION_GROUP_ADMIN"] != null)
            {
                ...
                ViewBag.data = products.ToList();

                var category = db.Types.ToList();
        ...
        public ActionResult Create([Bind(Include = "nameProduct,idProduct,sku,price,description,idType")] Products product, HttpPostedFileBase img1, HttpPostedFileBase img2)
        {
            if (Session["SESSION_GROUP_ADMIN"] != null)
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "nameProduct,idProduct,sku,price,description,idType")] Products product, HttpPostedFileBase img1, HttpPostedFileBase img2)
        {
            if (Session["SESSION_GROUP_ADMIN"] != null)
            {
                if (ModelState.IsValid)
